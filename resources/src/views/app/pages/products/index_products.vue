  ...
  computed: {
    ...
    columns() {
      return [
        ...
        { label: this.$t("Retail Price"), field: "price", tdClass: "text-left pre", thClass: "text-left" },
        { label: this.$t("Wholesale Price"), field: "wholesale_price", tdClass: "text-left pre", thClass: "text-left" },
