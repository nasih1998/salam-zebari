    ...
    <div class="container-fluid p-0 app-admin-wrap layout-sidebar-large clearfix" id="pos">
      ...
      <b-row v-if="!isLoading">
        ...
        <b-modal hide-footer size="md" scrollable id="Show_invoice" :title="$t('Invoice_POS')">
          <div id="invoice-POS">
            <div style="max-width:600px;margin:0px auto;padding:10px;font-family:Arial,sans-serif;font-size:10pt;">
              
              <!-- Header Box -->
              <div style="border:2px solid #000;padding:15px;text-align:center;margin-bottom:10px;">
                <div class="invoice_logo text-center mb-2">
                  <img :src="'/images/'+invoice_pos.setting.logo" alt style="max-width:80px;max-height:80px;">
                </div>
                <div style="font-size:16pt;font-weight:bold;margin-bottom:5px;">{{invoice_pos.setting.CompanyName}}</div>
              ...
              <table style="width:100%;border:1px solid #000;border-collapse:collapse;margin-bottom:10px;font-size:9pt;">
                <tr>
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;width:25%;">Invoice #:</td>
                  <td style="border:1px solid #000;padding:6px 10px;">{{invoice_pos.sale.Ref}}</td>
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;width:25%;">Date:</td>
                  <td style="border:1px solid #000;padding:6px 10px;">{{invoice_pos.sale.date}}</td>
                </tr>
                <tr v-show="pos_settings.show_customer">
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;">Customer:</td>
                  <td style="border:1px solid #000;padding:6px 10px;">{{invoice_pos.sale.client_name}}</td>
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;">Seller:</td>
                  <td style="border:1px solid #000;padding:6px 10px;">{{invoice_pos.sale.seller_name}}</td>
                </tr>
                <tr v-show="pos_settings.show_Warehouse">
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;">Warehouse:</td>
              ...
              <table style="width:100%;border:2px solid #000;border-collapse:collapse;margin-bottom:10px;font-size:9pt;">
                <thead>
                  <tr style="background:#f5f5f5;">
                    ...
                    <th style="border:1px solid #000;padding:8px 5px;text-align:left;font-weight:bold;">Product Name</th>
                    <th style="border:1px solid #000;padding:8px 5px;text-align:center;font-weight:bold;width:15%;">Code</th>
                    <th style="border:1px solid #000;padding:8px 5px;text-align:center;font-weight:bold;width:10%;">Qty</th>
                    <th style="border:1px solid #000;padding:8px 5px;text-align:right;font-weight:bold;width:15%;">Price</th>
                    <th style="border:1px solid #000;padding:8px 5px;text-align:right;font-weight:bold;width:15%;">Total</th>
                  </tr>
                </thead>
                <tbody>
              ...
              <div style="text-align:center;padding:8px;font-weight:bold;background:#f5f5f5;border:1px solid #000;border-top:2px solid #000;margin-bottom:10px;">
                Total Items: {{invoice_pos.details.length}}
              </div>
              ...
              <table style="width:50%;margin-left:auto;border:1px solid #000;border-collapse:collapse;margin-bottom:10px;font-size:9pt;">
                <tr v-show="pos_settings.show_discount && invoice_pos.sale.taxe > 0">
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;">Tax:</td>
                ...
                <tr v-show="pos_settings.show_discount && invoice_pos.sale.discount > 0">
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;">Discount:</td>
                ...
                <tr v-show="pos_settings.show_discount && invoice_pos.sale.shipping > 0">
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;">Shipping:</td>
                ...
                <tr style="font-weight:bold;font-size:10pt;">
                  <td style="border:1px solid #000;padding:8px 10px;background:#f5f5f5;">TOTAL:</td>
                ...
                <tr>
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;">Paid Amount:</td>
                ...
                <tr v-show="invoice_pos.sale.paid_amount < invoice_pos.sale.GrandTotal">
                  <td style="border:1px solid #000;padding:6px 10px;font-weight:bold;background:#f5f5f5;">Amount Due:</td>
              ...
              <table style="width:100%;border:1px solid #000;border-collapse:collapse;margin-bottom:15px;font-size:9pt;" v-show="invoice_pos.sale.paid_amount > 0">
                <thead>
                  <tr style="background:#f5f5f5;">
                    <th style="border:1px solid #000;padding:6px 10px;text-align:left;font-weight:bold;">Paid By:</th>
                    <th style="border:1px solid #000;padding:6px 10px;text-align:center;font-weight:bold;">Amount:</th>
                    <th style="border:1px solid #000;padding:6px 10px;text-align:right;font-weight:bold;">Change:</th>
                  </tr>
                </thead>
                <tbody>
              ...
              <!-- Barcode -->
              <div id="bar" class="text-center mt-3" v-show="pos_settings.show_barcode">
                <barcode
                  class="barcode"
