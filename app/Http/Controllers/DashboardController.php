...
class DashboardController extends Controller
{
    ...
    public function report_dashboard($request, $warehouse_id, $array_warehouses_id)
    {
        ...
        $helpers = new helpers();
        $data['today_sales'] = $helpers->formatNumber($data['today_sales']);
        ...
        $data['return_sales'] = $helpers->formatNumber($data['return_sales']);
        ...
        $data['today_purchases'] = $helpers->formatNumber($data['today_purchases']);
        ...
        $data['return_purchases'] = $helpers->formatNumber($data['return_purchases']);
