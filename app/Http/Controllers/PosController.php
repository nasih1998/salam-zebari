    ...
    public function GetProductsByParametre(request $request)
    {
        ...
        foreach ($product_warehouse_data as $product_warehouse) {
            if ($product_warehouse->product_variant_id) {
                ...
                $product_price = isset($productsVariants->wholesale) && $productsVariants->wholesale !== null 
                    ? $productsVariants->wholesale 
                ...
                // Use wholesale price if available, otherwise fall back to retail price
                $product_price = isset($product_warehouse['product']->wholesale_price) && $product_warehouse['product']->wholesale_price !== null
                    ? $product_warehouse['product']->wholesale_price
